...
# git@github.com:adriank/ObjectPath.git:tests/test_ObjectPath.py and
# licensed under the GNU AGPL 3 license (see the accompanying license
# file).

# This file has been modified to use SakStig instead of ObjectPath.
# Some tests have been modified to pass. In those cases, this has been
# documented inside the tests why they have been modified. Note that
# no modification has been done for behavior that is documented on
# objectpath.org, only for undocumented behavior!
